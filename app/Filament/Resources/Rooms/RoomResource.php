...
class RoomResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Inventaris Kamar';

    protected static ?string $modelLabel = 'Kamar & Suite';

    protected static ?string $pluralModelLabel = 'Inventaris Kamar & Suite';
